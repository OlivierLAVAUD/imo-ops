...
class IADFranceScraper:
    ...
    async def has_next_page(self) -> bool:
        ...
        try:
            # Utiliser une approche plus robuste pour éviter les problèmes de sélecteurs multiples
        ...
        try:
            if 'page=' in href:
                ...
                if page_match:
                    ...
                    # Supposer que les pages suivantes ont des numéros plus élevés
                    return page_num > 1
            return False
        except:
            return False
...
async def main():
    ...
    print(f"🏠 Nombre maximum de biens: {max_biens}")
    print(f"📄 Pages maximum: {max_pages}")
    
    await scraper.scrape(localisation=localisation, max_biens=max_biens, max_pages=max_pages)
